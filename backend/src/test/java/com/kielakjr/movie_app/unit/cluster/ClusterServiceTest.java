...
class ClusterServiceTest {
    ...
    class AddToClustersTests {
        ...
        void shouldAddToExistingCluster() {
            ...
            cluster.addMovie(1L, embedding1);

            clusterService.addToClusters(2L, embedding2, List.of(cluster));

            assertThat(cluster.getMovieIds()).containsExactly(1L, 2L);
        ...
        void shouldCreateNewCluster() {
            ...
            clusterService.addToClusters(2L, embedding2, clusters);

            assertThat(clusters).hasSize(2);
            assertThat(cluster.getMovieIds()).containsExactly(1L);
